        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'rgba(255, 255, 255, 0.75)', fontSize: 13.5, marginBottom: 10 }}
            >
            ...
            <a
              href={buildWhatsAppUrl("Olá! Gostaria de falar com a NC Construções.")}
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'rgba(255, 255, 255, 0.75)', fontSize: 13.5, marginBottom: 10 }}
            >
